            ...
            <div class="flex items-center justify-between gap-3">
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div>
                        ...
                        <p class="m-0 text-xs text-white/80">Convocation PDF Extraction Console</p>
                    </div>
                </div>
                ...
                <table class="min-w-full text-sm border-collapse">
                    ...
                    <tbody>
                        ...
                        <tr class="align-top bg-slate-50/50">
                            ...
                            <td class="p-3 border-b border-slate-100 text-slate-700">The uploaded PDF name. Example: <span class="font-semibold">Convocation 2018-2020 Pages.pdf</span>.</td>
                        </tr>
                        <tr class="align-top">
                        ...
                        <tr class="align-top">
                            ...
                            <td class="p-3 border-b border-slate-100 text-slate-700">Gemini key tier used for the job. Example: <span class="font-semibold">GEMINI_API_KEY_FREE_TIER_1</span>.</td>
                        </tr>
                        <tr class="align-top bg-slate-50/50">
